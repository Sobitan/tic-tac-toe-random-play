...
def randomly_select_player(p1,p2):
...
if __name__ == '__main__':
    ...
    p_x = randomly_select_player(p1,p2)
    ...
    human = Human()
    p_1 = randomly_select_player(p1, p2)
    p_x = randomly_select_player(human,p_1)
    ...
    while True:
        ...
        play_game(p_x, p_o, Environment(), draw=2)
